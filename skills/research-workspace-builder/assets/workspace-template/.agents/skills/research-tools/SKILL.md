...
The canonical task artifacts are `cache/cache_index.jsonl`, `cache/research_log.ndjson`, `cache/pages/*.md`, and `evidence.ndjson`. Reusable web pages may be materialized from `tasks/_global_cache/`.
